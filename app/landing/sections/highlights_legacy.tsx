...
const HighlightsLegacy = () => {
   ...
   return (
      <section className='max-w-[94vw] mx-auto px-4 md:mt-32 mt-16 mb-12 overflow-hidden'>
         <div ref={containerRef} className='gap-8 items-center flex flex-col lg:flex-row'>
            {/* Left Content */}
            <div className='flex flex-col lg:flex-row justify-between items-end gap-3 lg:gap-6 text-left'>
               <div className='flex flex-col urbanist-font'>
                  ...
                  <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-snug'>
                     Harvest Insights: Modern <br className='hidden lg:block' /> Farming Tips and
                     Techniques
                  </h1>
               </div>
               <motion.p
               ...
               >
                  Welcome to Harvest Insights, Kamco's blog dedicated to helping farmers thrive.
                  From expert advice on crop management to the latest innovations in agricultural
                  machinery, we share practical tips, industry news, and success stories to empower
                  modern farmers. Join us on the journey toward more sustainable, productive, and
                  profitable farming.
                  <br />
                  <span className='text-red-500 font-semibold mt-2 cursor-pointer'>Read More</span>
               </motion.p>
            </div>
...
export default HighlightsLegacy;
