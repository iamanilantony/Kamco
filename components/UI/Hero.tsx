...
const Hero = () => {
  return (
    ...
    >
      {/* Text Content */}
      <div className="order-2 md:order-1 flex flex-col space-y-4 w-full md:w-1/2 items-start animate__animated animate__fadeIn animate__delay-1s">
        ...
        <p className="text-gray-200 font-medium text-base w-full md:w-3/4 mb-4 font-sans text-left animate__animated animate__fadeIn animate__delay-2s animate__bounceInUp">
        ...
        <div className="flex justify-between md:justify-start sm:space-y-0 sm:space-x-4 animate__animated animate__fadeIn animate__delay-2s animate__bounceInUp">
          ...
          <Link href="/dealers" className="border text-white border-white text-gray-900 px-2 md:px-6 py-3 text-xs h-10 md:h-max md:font-base rounded-md hover:border-gray-400 hover:text-white transition font-sans">
            Explore Dealers
          </Link>
        </div>
      </div>
