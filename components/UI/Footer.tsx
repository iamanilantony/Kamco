...
const FooterSection = () => {
    return (
        <div className="bg-[#166434] text-white py-10 px-4">
            {/* Newsletter Section */}
            <div className="mb-8 bg-white text-gray-800 font-sans flex items-center justify-center py-8">
                <span className='bg-black p-6 mr-6'>
                ...
                <div className="flex">
                    <input
                        ...
                        className="p-2 rounded-l-lg border border-gray-300 focus:outline-none w-96"
                    />
            ...
            <div className='flex mt-16 justify-between'>
                <div className="mb-8 font-normal w-2/5">
                    <h2 className="text-3xl mb-4">KAMCO</h2>
                    <p className="mb-4 w-4/5 font-sans">
                ...
                {/* Navigation Links */}
                <div className="grid grid-cols-2 md:grid-cols-2 gap-4 font-sans text-normal w-1/5">
                    <div className='mr-40'>
                        <ul>
                            <li className='mb-4'><Link className='' href="/dealers">Products</Link></li>
                            <li className='mb-4'><Link className='' href="/dealers">Dealers</Link></li>
                            <li className='mb-4'><Link className='' href="/tenders">Tenders</Link></li>
                            <li className='mb-4'><Link className='' href="/notifications">Notifications</Link></li>
                            <li className='mb-4'><Link className='' href="/highlights">Highlights</Link></li>
                            <li className='mb-4'><Link className='' href="/highlights">Production</Link></li>
                            <li className='mb-4'><Link className='' href="/highlights">CSR</Link></li>
                        </ul>
                    </div>
                    <div>
                        <ul>
                ...
                <div className='font-sans mr-4'>
                    ...
                    <ul className="flex space-x-4 flex-col justify-center items-center">
