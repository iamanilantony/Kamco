...
export default function Hero() {
  return (
    <div className="relative max-sm:h-[85dvh] max-sm:mt-8 lg:h-[90vh] overflow-hidden w-[94vw] mx-auto rounded-lg">
        ...
        >
          ...
          <div className="max-w-3xl space-y-6">
            ...
            <p className="max-w-xl text-lg text-gray-200 sm:text-xl text-left">
              ...
              unstoppable growth, enabling greater efficiency and sustainable
              success.
            </p>
          </div>
