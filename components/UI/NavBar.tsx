    ...
    return (
        <header className="flex flex-wrap items-center justify-between p-4 md:px-6 font-sans">
            ...
            <nav className={`w-full md:flex md:w-auto space-y-4 md:space-y-0 md:space-x-6 p-2 md:p-4 items-center mt-4 md:mt-0 ${isMenuOpen ? 'block' : 'hidden'} md:flex-row text-center bg-white md:bg-transparent rounded-lg md:rounded-none shadow-md md:shadow-none`}>
                <Link href="/" className={`block md:inline-block text-gray-700 px-1 md:px-2 font-normal transition-all duration-200 ease-in-out ${isActive('/') ? 'font-semibold text-[#166434]' : 'hover:font-semibold hover:scale-105'}`}>
                    <span className="inline-block min-w-[80px] text-center">Home</span>
                </Link>
                <Link href="/aboutUs" className={`block md:inline-block text-gray-700 px-1 md:px-2 font-normal transition-all duration-200 ease-in-out ${isActive('/aboutUs') ? 'font-semibold text-[#166434]' : 'hover:font-semibold hover:scale-105'}`}>
                    <span className="inline-block min-w-[80px] text-center">About Us</span>
                </Link>
                <Link href="/products" className={`block md:inline-block text-gray-700 px-1 md:px-2 font-normal transition-all duration-200 ease-in-out ${isActive('/products') ? 'font-semibold text-[#166434]' : 'hover:font-semibold hover:scale-105'}`}>
                    <span className="inline-block min-w-[80px] text-center">Products</span>
                </Link>
                <Link href="/tenders" className={`block md:inline-block text-gray-700 px-1 md:px-2 font-normal transition-all duration-200 ease-in-out ${isActive('/tenders') ? 'font-semibold text-[#166434]' : 'hover:font-semibold hover:scale-105'}`}>
                    <span className="inline-block min-w-[80px] text-center">Tenders</span>
                </Link>
                <Link href="/notifications" className={`block md:inline-block text-gray-700 px-1 md:px-2 font-normal transition-all duration-200 ease-in-out ${isActive('/notifications') ? 'font-semibold text-[#166434]' : 'hover:font-semibold hover:scale-105'}`}>
