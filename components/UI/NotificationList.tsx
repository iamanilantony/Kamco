  ...
  return (
    <div className="p-6 min-h-screen font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex space-x-4 text-lg font-semibold border-b border-green-700 mb-4">
        ...
        <div className="space-y-6">
          {filteredData.map((item, index) => (
            <div key={index} className="bg-white p-4 rounded-md flex items-center">
              <div className="text-lg text-gray-500 mb-2 text-right min-w-fit font-semibold pr-4 border-r-2 border-green-700">
                <div>{item.date}</div> <div>{item.time}</div>
              </div>
              <div className="h-full w-px bg-green-700 mx-4"></div>
