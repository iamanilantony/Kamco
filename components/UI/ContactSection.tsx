    ...
    return (
        <div className="flex flex-col md:flex-row py-10">
            ...
            <div className="md:w-[500px] p-2 border-2 border-[#166434] md:rounded-full rounded-xl flex flex-col justify-center mx-auto md:mx-16 mb-8 md:mb-0"> {/* Centered on mobile */}
                <h2 className="text-2xl font-normal mb-4 text-center md:text-left">CHIEF MINISTER’S REDRESSAL CELL</h2>
                <p className="mb-2 text-center md:text-left">Charge Officer - KAMCO:</p>
                <p className="mb-2 text-center md:text-left">Shri. Vijayakumar M C, Sr. Manager (HR)</p>
                <p className="mb-2 text-center md:text-left">Phone: +91-944 699 2031, 0484-2474301</p>
                <p className="mb-2 text-center md:text-left">Email: vijayakumar@kamcoindia.com</p>
                <p className="mb-2 text-center md:text-left">Visiting Time: 3 PM - 4 PM</p>
            </div>
