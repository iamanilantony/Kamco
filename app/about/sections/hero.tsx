  ...
  return (
    <div className="px-4 md:py-8 md:px-16 md:pb-16">
      <div className="w-full flex flex-col justify-end items-start text-white bg-[url('/new_images/about/heroImage.webp')] bg-cover bg-center h-full min-h-[80vh] rounded-3xl relative z-10 overflow-hidden">
        ...
        <div className="text-left p-4 max-sm:pb-12 md:p-16 md:py-24 space-y-4 md:space-y-6  md:max-w-[calc(90vw-3rem)] relative z-10">
          ...
          <p className="text-sm md:text-lg inter-font">
            ...
            <br className="md:hidden" />
            From our humble beginnings to becoming a global leader, KAMCO has
            always been driven by a passion for agriculture and a dedication to
            our customers. Our unwavering focus on research and development has
            led to the creation of a diverse range of products, including
            tractors, tillers, reapers, and more.
          </p>
        </div>
      </div>
    </div>
