...
export default function Hero() {
   return (
      <div className='relative lg:h-[90vh] overflow-hidden w-[94vw] mx-auto rounded-lg'>
            ...
            >
               ...
               <div className='max-w-3xl space-y-6'>
                  ...
                  <p className='max-w-xl text-lg text-gray-200 sm:text-xl text-left'>
                     Unleashing the power of innovation—tools that turn hard work into unstoppable
                     growth, enabling greater efficiency and sustainable success.
                  </p>
               </div>
               ...
               {/* Statistics Grid */}
               <div className='mt-2 grid w-full grid-cols-2 gap-4 sm:grid-cols-4 md:gap-6'>
                  {[
