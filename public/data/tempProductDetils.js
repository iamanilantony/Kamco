export default [
  {
    "id": "PR-011",
    "name": "Power Tillers",
    "image": ["/new_images/products/powertiller.webp"],
    "specs": [
  ...
  },
  {
    ...
    "specs": [
      ...
      { "label": "Fuel Consumption", "value": "5 litres per hour" },
    ...
    "highlights": [
      {
        "icon": "ShieldCheck",
        "text": "3-year warranty on engine and major parts"
      },
      {
        "icon": "VscTools",
        "text": "Free maintenance for the first year"
      },
      {
        "icon": "CircleCheck",
        "text": "Compatible with various agricultural implements"
      }
    ],
    "additionalFeatures": [
      "Power Steering: Easy maneuverability with power steering.",
  ...
  },
  {
    ...
    "specs": [
      ...
      { "label": "Camera", "value": "4K resolution" }
    ],
    "highlights": [
      {
        "icon": "ShieldCheck",
        "text": "1-year warranty on drone and accessories"
      },
      {
        "icon": "VscTools",
        "text": "Free software updates for the first year"
      },
      {
        "icon": "CircleCheck",
        "text": "Compatible with various agricultural sensors"
      }
    ],
    "additionalFeatures": [
      "GPS Navigation: Precise GPS navigation for accurate operations.",
  ...
  },
  {
    ...
    "specs": [
      ...
      { "label": "Fuel Consumption", "value": "1 litre per hour" },
      { "label": "Fuel tank Capacity", "value": "5 litres" },
    ...
    "highlights": [
      ...
      {
        "icon": "CircleCheck",
        "text": "Compatible with various weeding attachments"
      }
    ],
    "additionalFeatures": [
      "Adjustable Handle: Ergonomic handle for comfortable operation.",
  ...
  },
  {
    ...
    "specs": [
      ...
      { "label": "Fuel Consumption", "value": "1.2 litres per hour" },
    ...
    "additionalFeatures": [
      "Geared Transmission: Efficient power transfer with geared transmission.",
  ...
  },
  {
    ...
    "specs": [
      ...
      { "label": "Fuel Consumption", "value": "0.8 litres per hour" },
      { "label": "Fuel tank Capacity", "value": "3 litres" },
      { "label": "Weight", "value": "30 kg" }
    ],
    "highlights": [
      {
        "icon": "ShieldCheck",
        "text": "1-year warranty on engine and major parts"
      },
      {
        "icon": "VscTools",
        "text": "Free maintenance for the first year"
      ...
      {
        "icon": "CircleCheck",
        "text": "Compact design for easy storage"
      }
    ],
    "additionalFeatures": [
  ...
  },
  {
    ...
    "highlights": [
      {
        "icon": "ShieldCheck",
        "text": "1-year warranty on major parts"
      },
      {
        "icon": "VscTools",
        "text": "Free maintenance for the first year"
      ...
      {
        "icon": "CircleCheck",
        "text": "Easy to use and maintain"
      }
    ],
    "additionalFeatures": [
      "Lightweight: Easy to handle and operate.",
  ...
  },
  {
    ...
    "specs": [
      ...
      { "label": "Fuel Consumption", "value": "1 litre per hour" },
      { "label": "Fuel tank Capacity", "value": "4 litres" },
    ...
    "highlights": [
      ...
      {
        "icon": "CircleCheck",
        "text": "Compatible with various cutting attachments"
      }
    ],
    "additionalFeatures": [
      "Powerful Engine: High-performance engine for tough tasks.",
  ...
  },
  {
    ...
    "specs": [
      ...
      { "label": "Fuel Consumption", "value": "2 litres per hour" },
      { "label": "Fuel tank Capacity", "value": "12 litres" },
    ...
    "highlights": [
      ...
      {
        "icon": "CircleCheck",
        "text": "Efficient and reliable performance"
      }
    ],
    "additionalFeatures": [
      "High Capacity: Capable of handling large-scale harvesting.",
