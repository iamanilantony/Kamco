...
const FAQsSectionLegacy = () => {
   const [activeIndex, setActiveIndex] = useState<number | null>(null);

   const faqs = [
      {
         title: 'Is KAMCO the only government company in agriculture mechanization in India?',
         description:
      ...
      {
         title: 'Does KAMCO offer a wide range of products for different farming needs?',
         description:
      ...
      {
         title: 'Will KAMCO assist farmers with SMAM registration and other related procedures?',
         description:
      ...
      {
         title: 'What are the key benefits of choosing KAMCO’s agricultural machinery?',
         description:
   ...
   return (
      <section ref={ref} className='my-32 px-12'>
         <div className='md:max-w-7xl mx-auto innerdiv space-y-12'>
            ...
            >
               <h3 className='text-xl md:text-2xl text-[rgb(52,121,40)] leading-snug'>FAQs</h3>
...
export default FAQsSectionLegacy;
