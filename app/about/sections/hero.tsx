...
const Hero = () => {
  return (
    <div className="px-4 py-8 md:px-16 md:py-16">
      <div className="w-full flex flex-col justify-end items-start text-white bg-[url('/new_images/about/heroImage.webp')] bg-cover bg-center h-full min-h-[50vh] rounded-3xl relative z-10 overflow-hidden">
