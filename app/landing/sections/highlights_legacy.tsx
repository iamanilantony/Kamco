  ...
  return (
    <section className="max-w-[94vw] mx-auto px-4 md:mt-32 mt-16 mb-12 overflow-hidden">
      ...
      <div className="mt-8 flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-0">
        {/* <button className="bg-[#fafff7] py-3 md:py-5 px-8 md:px-16 rounded-2xl text-xl md:text-2xl urbanist-font capitalize">
          view all articles
        </button> */}
        <Animatedbutton delay={0.5} viewBased className="bg-[#fafff7]">
          View All Articles
        </Animatedbutton>
