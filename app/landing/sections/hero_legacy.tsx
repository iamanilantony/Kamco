    ...
    <div className="flex justify-start items-center flex-col gap-2 md:min-h-[80vh] px-4 md:px-0">
      ...
      <div className="max-w-full md:max-w-[94vw] w-full flex flex-col md:flex-row justify-between">
        ...
        <div className="flex flex-col space-y-3 mt-6 md:mt-0 px-4 md:px-0">
          ...
          <Link
            href="/dealers"
            className="bg-[#fafff7] py-3 md:py-5 px-8 md:px-16 rounded-2xl hover:bg-[#beff96] text-base sm:text-lg md:text-2xl urbanist-font cursor-pointer z-10 transition-all duration-300 ease-in-out"
          >
            Explore Dealers
          </Link> */}
          <Animatedbutton
          ...
          <Animatedbutton
            navigateto={"/dealers"}
            delay={1.2}
            className="bg-[#fafff7] hover:bg-[#beff96]"
          >
            Explore Dealers
          </Animatedbutton>
        </div>
